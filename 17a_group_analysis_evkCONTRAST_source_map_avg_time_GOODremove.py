...
for ei, evnt in enumerate(event_type):
    ...
    for veri, version in enumerate(version_list):
        ...
        for datakind in group_data_stat:
            ...
            time_points_kind = ['T0','T1', 'T2', 'T3', 'T4']
            ...
            for ti2, time_pos2 in enumerate(time_points_kind): 
                ...
                for ci2, condi2 in enumerate(contrast_kind):                 
                    ...
                    if time_pos2 == 'T0': 
                        ...
                        tmax = t0max 
                        timeDur = str(int(tmin*1000)) + '_' + str(int(tmax*1000)) 
                        print('plotting T0 activations for ' + condi2)
                    ...
                    ### comment/uncomment to use common or abs scale b/w conditions
                    ### abs scale: 
                    ...
                    # vmin = 0.0 * vrange + stc_min_value_T[ti2]
                    # vmid = 0.50 * vrange + stc_min_value_T[ti2]
                    # vmax = 0.95 * vrange + stc_min_value_T[ti2]
                    ...
                    # LH
                    if time_pos2 == 'T1' or time_pos2 == 'T0':
            ...
            report.title = 'Group (n = ' + str(n_subs) + ') stc evkContrast_'+  datakind + '_' + evnt + ': ' + version + '_' + orientation + '_' + method + '_' + ampliNormalization
            extension = 'group_stc_evkContrast_'+  datakind +'_maps'
