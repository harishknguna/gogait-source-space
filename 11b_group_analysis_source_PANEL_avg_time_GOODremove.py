...
report.title = 'Group (n = ' + str(n_subs) + ') STC_'+  datakind +'_' + evnt + ': ' + version + '_' + orientation + '_' + method + '_' + ampliNormalization + '_' + scale
extension = 'group_PANEL_stc_'+  datakind +'_maps'
